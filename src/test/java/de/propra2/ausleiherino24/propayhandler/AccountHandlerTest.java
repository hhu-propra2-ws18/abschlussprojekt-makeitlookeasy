...
public class AccountHandlerTest {
  ...
  public void transferFundsWorksWithValidFunds() {
    ...
    Mockito.when(restTemplate
        .exchange(ACCOUNT_URL + "/{sourceAccount}/transfer/{targetAccount}", HttpMethod.POST,
    ...
    Mockito.verify(restTemplate, Mockito.times(1))
        .exchange(ACCOUNT_URL + "/{sourceAccount}/transfer/{targetAccount}", HttpMethod.POST,
            request, Double.class, "Acc1", "Acc2");
  }
  ...
  public void addFundsAddsFoundsIfStatusCodeIsAccepted() {
    ...
    Mockito.when(restTemplate
        .exchange(ACCOUNT_URL + "/{account}", HttpMethod.POST, request, Double.class, "Acc1"))

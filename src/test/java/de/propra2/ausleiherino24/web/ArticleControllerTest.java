...
class ArticleControllerTest {
    ...
    @Test
    @WithMockUser(roles = "user")
    void deactivateArticleShouldNotDeactivateArticleIfSomeArticleCasesAreNotClosed() throws Exception {
    ...
    void getEventsForCalendarShouldReturnAllEventsFromOneArticle() throws Exception {
        ...
        Mockito.when(calendarEventService.getAllEventsFromOneArticle(1L)).thenReturn(Arrays.asList(event1, event2));
